                ...
                <div className="pb-20 flex flex-col gap-4 ">
                    ...
                    <div className="mb-5 mt-3">
                        ...
                        <input
                            ...
                            className={ errors.nombre && touched.nombre ? " border  border-red-600 w-full p-2 mt-2 rounded focus:outline-none " : "border  w-full p-2 mt-2 rounded focus:outline-none"}
                            type="text"
                            name='nombre'
                    ...
                    <div className='mb-5'>
                        <input
                            ...
                            onChange={handleChange}
                            name='email'
                            className={ errors.email && touched.email ? " border  border-red-600 w-full p-2 mt-2 rounded focus:outline-none " : "border  w-full p-2 mt-2 rounded focus:outline-none"}
                            type="email"
                    ...
                    <div className='mb-5'>
                        <input
                            ...
                            onChange={handleChange}
                            name='telefono'
                            className={ errors.telefono && touched.telefono ? " border  border-red-600 w-full p-2 mt-2 rounded focus:outline-none " : "border  w-full p-2 mt-2 rounded focus:outline-none"}
                            type="tel"
                    ...
                    />
                      ...
                      {successMessage &&  <p className='text-[12px] bg-yellow-600 text-white p-2 flex gap-2 '>
                        <RiMailSendLine size={20}/>Mensaje enviado</p>   }
                    </div>
